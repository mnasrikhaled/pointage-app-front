...
abstract class LoginEtudaintController extends GetxController {
  login();
  gotoSignUp();
  gotoForgetPassword();
}

class LoginEtudaintControllerImp extends LoginEtudaintController {
  ...
  gotoSignUp() {
    ...
    Get.delete<LoginEtudaintControllerImp>();
  }
    ...
    if (formdata!.validate()) {
      ...
      if (StatusRequest.success == statusRequest) {
        if (response["status"] == "invalid") {
          Get.offNamed(AppRoute.homeetudiant);
